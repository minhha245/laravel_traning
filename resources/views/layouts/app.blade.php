...
<head>
    ...
    <script src="{{ asset('resources/js/uploadImg.js') }}"></script>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                                ...
                                <a class="dropdown-item active" href="{{route('teams.search')}}">Search</a>
                                <a class="dropdown-item" href="{{route('teams.create')}}">Create</a>
